...
$(document).ready(function () {
    var myTable = $('#myTable').dataTable({
        ...
        "columnDefs": [
          ...
          {
              "render": function (data, type, row) {
                    return '<a class="btn btn-outline-primary btn-sm checkInventory" data-prod_id="'+row.prod_id+'" href="#!" >Revisar Inventario y Precios <i class="far fa-hand-pointer"></i> </a>' ;
              },
          ...
          if(res['type'] === "success"){
            ...
            html +='<div class="row">\
              ...
              <div class="col-sm-8">\
                <div class="row">\
                  <div class="col-sm-12">\
                    <div class="product_name"> <b>Nombre del Producto: </b>'+val.product_name+'</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_name"> <b>Forma de venta: </b>'+val.sold_as+'</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_attribute"><b>'+val.attributes_name+' : </b>'+val.attributes_value+'</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_price"><b>Precio: </b>'+val.price+'</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_tax_rate"><b>Impuestos: </b>'+val.tax_rate+' %</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_selling_price"><b>Precio de Venta: </b>'+sell_price+' $</div>\
                  </div>\
                  <div class="col-sm-12">\
                    <div class="product_inventory"><b>Inventario: </b>'+val.inventory+'</div>\
                  </div>\
                </div>\
              </div>\
            </div>';
