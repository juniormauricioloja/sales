  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=admin_url("dashboard")?>">
        ...
        <div class="sidebar-brand-text mx-3">Ventas e Inventario</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategory" <?php if($this->router->class=="category"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('category')?>">Lista</a>
            <a <?php if($this->router->method=="add"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('category/add')?>">Agregar Categoria</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseBrands" <?php if($this->router->class=="brands"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('brands')?>">Lista</a>
            <a <?php if($this->router->method=="add"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('brands/add')?>">Agregar Marca</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseAttributes" <?php if($this->router->class=="attributes"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('attributes')?>">Lista</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseProducts" <?php if($this->router->class=="products"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('products')?>">Lista</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseSales" <?php if($this->router->class=="sales"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="add"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('sales')?>">Lista</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseInventory" <?php if($this->router->class=="inventory"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('inventory')?>">Inventario</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseReports" <?php if($this->router->class=="reports"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('reports')?>">Reportes</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span> &copy; Sistema Ventas e Inventario Inguibra - <?php echo date("Y"); ?></span><br/> <br/>
            <span>Developed by JsGv</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Seleccione "Salir" si esta seguro de finalizar la sesión actual</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-success" href="<?=admin_url('admin/login/logout')?>">Salir</a>
        </div>
      </div>
    </div>
  </div>
