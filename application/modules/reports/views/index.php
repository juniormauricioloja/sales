            ...
            <div class="card-body">
              ...
              <div class="mg-top-20">
                <a href="<?=admin_url('reports/products')?>" class="btn btn-danger btn-sm btn-icon-split">
                  <span class="text">Descargar</span><span class="icon text-white-50"><i class="fas fa-download"></i></span>
                </a>
            ...
            <div class="card-body">
              ...
              <div class="mg-top-20">
                <button id="btn_generate_sales_report" class="btn btn-danger btn-sm btn-icon-split">
                  <span class="text">Generar Reporte</span><span class="icon text-white-50"><i class="fas fa-download"></i></span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <button id="btn_download_sales_reports" type="submit" class="btn btn-danger btn-sm btn-icon-split">
                <span class="text">Descargar Reporte</span><span class="icon text-white-50"><i class="fas fa-download"></i></span>
              </button>
            </div>
          </div>
        </form>
