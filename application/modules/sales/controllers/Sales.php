...
class Sales extends Admin_Controller
{
    ...
    if($products) {
      ...
      echo '<option value="">Datos no Encontrados</option>';
    }
    }
    ...
    { //var_dump($this->input->post());die;
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          if($result){
            ...
            $this->session->set_flashdata(array('message'=>'Venta agregada satisfactoriamente','type'=>'success'));
          }else {
            $this->session->set_flashdata(array('message'=>'Algo salio salio mal, intentalo de nuevo','type'=>'warning'));
          }
    ...
    public function delete()
    {
      ...
      if($result){
        ...
        echo json_encode(array('message'=>'Venta eliminada satisfactoriamente','type'=>'success'));
      }else {
