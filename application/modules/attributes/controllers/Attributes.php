...
class Attributes extends Admin_Controller
{
    ...
    public function add_attributes()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          if($attributes_id){
            ...
            $this->session->set_flashdata(array('message'=>'Atributo agregado satisfactoriamente','type'=>'success'));
          }else {
            $this->session->set_flashdata(array('message'=>'Algo salio mal, intentalo de nuevo','type'=>'warning'));
          }
    ...
    {   $this->layout->add_js('../public/pekeupload/js/pekeUpload.js');
        if(check_post()){
          ...
          if($result){
            $this->session->set_flashdata(array('message'=>'Atributo actualizado satisfactoriamente','type'=>'success'));
          }else {
            $this->session->set_flashdata(array('message'=>'Algo salio mal, intentalo de nuevo','type'=>'warning'));
          }
          redirectToAdmin('attributes');
          ...
          if ($row) {
            ...
            $this->session->set_flashdata(array('message'=>'Datos no encontrados','type'=>'warning'));
            redirectToAdmin('attributes');
          }
        }
    ...
    public function delete()
    {
      ...
      if($result){
        ...
        echo json_encode(array('message'=>'Atributo eliminado satisfactoriamente','type'=>'success'));
      }else {
        echo json_encode(array('message'=>'Algo salio mal, intentalo de nuevo','type'=>'warning'));
      }
    }
