...
class Brands extends Admin_Controller
{
    ...
    public function add_brands()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          if($result){
            ...
            $this->session->set_flashdata(array('message'=>'Marca agregada satisfactoriamente','type'=>'success'));
          }else {
    ...
    {   $this->layout->add_js('../public/pekeupload/js/pekeUpload.js');
        if(check_post()){
          ...
          if($result){
            $this->session->set_flashdata(array('message'=>'Marca actualizada satisfactoriamente','type'=>'success'));
          }else {
            $this->session->set_flashdata(array('message'=>'Algo salio mal. Intentalo de nuevo','type'=>'warning'));
          }
          redirectToAdmin('brands');
          ...
          if ($row) {
            ...
            $this->session->set_flashdata(array('message'=>'Dato no encontrado','type'=>'warning'));
            redirectToAdmin('brands');
          }
        }
    ...
    public function delete()
    {
      ...
      if($result){
        ...
        echo json_encode(array('message'=>'Marca eliminada satisfactoriamente','type'=>'success'));
      }else {
